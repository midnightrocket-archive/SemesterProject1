...
class ActivityTest {
    ...
    public void testConstructorAndGetter() {
        ArrayList<ArrayList<String>> inputFile = this.loadFile("src/test/java/resources/Classes/ActivityTest.csv");
        ArrayList<ArrayList<String>> expectedOutputFile = this.loadFile("src/test/java/resources/Classes/ActivityTest_expected.csv");
