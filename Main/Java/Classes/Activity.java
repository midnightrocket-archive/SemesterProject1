...
public class Activity {
    private final String name; // The name of the activity. Will show up in possible activities.
    ...
    private boolean activityDone = false; // False if activity is not done, true if activity is done.
